      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <motion.div
            ...
            className="bg-white rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow duration-300 border border-pink-light"
          >
            <div className="flex items-center mb-4">
              <svg
                className="w-6 h-6 text-pink-dark mr-4"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-pink-dark">
                Instagram
              </h2>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center text-pink-dark hover:text-pink-medium transition-colors font-medium"
            >
              @arkista
              <svg
